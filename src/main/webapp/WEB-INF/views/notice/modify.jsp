		...
		<div class="card mb-4">
			...
			<div class="card-body">
				...
				<div class="form-group col-md-12">
					<div class="mb-3">
						<label for="title" class="form-label">Title</label> <input
							...
							value='<c:out value="${notice.title }"></c:out>' required="required">
					</div>
				</div>
				<div class="form-group col-md-12">
					<div class="mb-3 row">
				...
				<div class="form-group col-md-12">
					<div class="mb-3">
						...
						<textarea class="form-control border border-secondary" id="content" name="content"
							rows="3" required="required"><c:out value="${notice.content }"></c:out></textarea>
					</div>
				</div>
				...
				<input type="submit" class="btn btn-outline-success btn-sm" value="Submit" style="float: right;">
					<a href="/notice/list" class="btn btn-outline-primary btn-sm" style="float: right;">List</a>
					</form>
				</div>
			</div>
		</div>
